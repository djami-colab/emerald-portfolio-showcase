...
import { Atom, Hexagon, Braces, Figma } from "lucide-react";
          ...
          <div className="flex flex-col items-center gap-6 lg:items-end">
            <div className="relative grid h-64 w-64 place-items-center sm:h-72 sm:w-72">
              ...
              <div className="relative grid h-52 w-52 place-items-center rounded-full bg-gradient-to-br from-ink to-ink/85 sm:h-60 sm:w-60">
                <div className="grid grid-cols-2 gap-5 text-emerald">
                  <div className="grid h-12 w-12 place-items-center rounded-xl bg-background/10 backdrop-blur-sm ring-1 ring-emerald/30">
                  ...
                  <div className="grid h-12 w-12 place-items-center rounded-xl bg-background/10 backdrop-blur-sm ring-1 ring-emerald/30">
                    <Braces className="h-6 w-6" strokeWidth={1.5} />
                  </div>
                  <div className="grid h-12 w-12 place-items-center rounded-xl bg-background/10 backdrop-blur-sm ring-1 ring-emerald/30">
                    <Figma className="h-6 w-6" strokeWidth={1.5} />
                  </div>
                </div>
